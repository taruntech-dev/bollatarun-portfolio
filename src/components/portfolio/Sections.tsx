...
const STATS = [
  ...
  { icon: MapPin, label: "Paralakhemundi, Odisha" },
];
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
          <Reveal className="glass glass-hover p-8">
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              ...
              and Engineering at NIST University, Paralakhemundi, Odisha, with an expected
            ...
            <article className="glass glass-hover p-7">
              <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4">
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">Paralakhemundi, Odisha</p>
                </div>
